  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={moveToYourOrders.js} style={styles.button}>
        ...
        <TouchableOpacity onPress={moveContactInfo.jsx} style={styles.button}>
          <Text style={styles.buttonText}>Contact us</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={moveToLoginScreen.jsx} style={styles.button}>
